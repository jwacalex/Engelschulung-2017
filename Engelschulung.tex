...
\subsubsection{Feedback Meeting}
...
\item Organization or social problems? VOC Angel Coordination
\item General Angel Topics? Heaven
\item Unable to find right person for issue? VOC Angel Coordination
\end{itemize} 
\end{frame}

\begin{frame}{VOC Angel Coordination}
\begin{itemize}
	\item jwacalex, DECT 5523 and sophie, DECT 7425
	\item in person, via dect or via engelsystem
	\item if there is anything, please let us know.
\end{itemize} 
\end{frame}
